...
class Updating extends React.Component {
  ...
  static getDerivedStateFromProps(props, state) {
    ...
    */
   console.log('getDerivedStateFromProps child updating phase' , state)
  }
  ...
  shouldComponentUpdate(nextProps, nextState) {
    ...
    */
   console.log(nextProps, nextState, 'shouldComponentUpdate child');
    return true;
  //  return false;
  }
  ...
  getSnapshotBeforeUpdate(prevProps, prevState) {
    console.log(prevProps, prevState, 'getSnapshotBeforeUpdate child');
  ...
  componentDidUpdate(prevProps, prevState, snapshot) {
    console.log(prevProps, prevState,snapshot, 'componentDidUpdate child');
    /**
  ...
  render() {
    console.log('render function is the third function called in updating state child');
    const { age } = this.state;
    return (
      <div>
        <p>{age}</p>
